...
const MostrarCuestionarios = ({ token }) => {
	...
	return (
		<>
			<div className="container fade-in" style={{ overflow: 'hidden' }}>
				<h1 className="display-1 mt-2  ">Lista de cuestionarios</h1>
					...
					{cuestionarios.map((cuestionario) => {
						return (
							<div
								...
								className="container text-center p-3 my-5 bg-light shadow rounded col-3 overflow-auto"
							>
								...
								<div className="row d-flex justify-content-evenly ">
									<button
										...
										onClick={() => handleEditar(cuestionario.id)}
									>
										Editar
									</button>
									...
									{userId === cuestionario.creador_id && (
										<button
											className="btn btn-outline-danger btn-sm col-4"
