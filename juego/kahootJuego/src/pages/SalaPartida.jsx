...
export const SalaPartida = () => {
	...
	const { sala, crearPartida, unirsePartida, salirPartida, empezarPartida, siguientePregunta, enviarRespuestaJugador } =
	...
	const mostrarPantallaJuego = () => {
		return joinToken == null ? (
			<PantallaHost sala={sala} siguientePregunta={siguientePregunta} />
		) : (
